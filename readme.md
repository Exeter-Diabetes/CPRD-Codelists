...
* Patient date of birth = 15th of month of birth (where month of birth and year of birth available), and 30th June where only year of birth available, or earliest medcode in Observation table if this is earlier (excluding medcodes before mob/yob)
