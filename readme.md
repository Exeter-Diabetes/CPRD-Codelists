...
In 2024, we updated some of our algorithms and codelists (main branch of this repository), in addition to adding new codelists. Papers published by the Exeter Diabetes team in or prior to 2024 use the algorithms and codelists in the 'pre-2024' branch of this repository, all of which were based on the October 2020 extract of CPRD Aurum. Where we have updated codelists since then, we have added in additional codes which appear in the June 2024 extract of CPRD Aurum (where these exist), but haven't removed codes which were in the October 2020 but not the June 2024 extract; thus the codelists are compatible with either extract. New codes were found by rejoining the original validated Read and SNOMED codelists (see https://github.com/Exeter-Diabetes/CPRD-Codelists/tree/main?tab=readme-ov-file#medcodes) with the June 2024 CPRD Aurum Medical Dictionary, or by searching for key words/terms in the June 2024 CPRD Aurum Medical Dictionary (whichever method was used to create the original 2020 codelist). Any new codes found were reviewed befoe addition. Codelists which have been updated are: 'all diabetes' (medcodes); 'QOF diabetes' (medcodes); diabetes insipidus (medcodes; not used pre-2024); family history of diabetes; all biomarkers; comorbidities: atrial fibrillation, angina, CKD5, heart failure, hypertension, IHD, MI, PAD, revascularisation, stroke, and TIA (all medcodes); insulin (prodcodes) and OHAs (prodcodes). Some codelists have also changed in their scope due to changes in the algorithms they are used with: 'all diabetes' now contains all types of diabetes mellitus (previously, codes for non-type 1/type 2 diabetes were in an 'exclusion diabetes' codelist which also included diabetes insipidus; the latter is now a separate codelist).
...
In addition, a subset of medcode lists were generated by alternative means: Covid medcodes were provided by CPRD; ethnicity medcodes were provided by LSHTM; care home, bipolar disorder and schizophrenia medcodes were provided by collaborators; family history, frailty ('frailty_simple'), diabetes, learning disabilities, severe mental illness, surgical pancreatic resection, pancreatic insufficiency and various biomarker medcodes (C-peptide, cholesterol:HDL ratio, GAD/IA2/ICA antibodies, HbA1c) were generated by searching for key words/terms in the CPRD Aurum Medical Dictionary for completeness. Read and SNOMED codelists are not available for these conditions/biomarkers.
