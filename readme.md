...
In 2024, we updated some of our algorithms and codelists (main branch of this repository), in addition to adding new codelists. Papers published by the Exeter Diabetes team in or prior to 2024 use the algorithms and codelists in the 'pre-2024' branch of this repository, all of which were based on the October 2020 extract of CPRD Aurum. Where we have updated codelists since then, we have added in additional codes which appear in the June 2024 extract of CPRD Aurum (where these exist), but haven't removed codes which were in the October 2020 but not the June 2024 extract; thus the codelists are compatible with either extract. New medcodes were found by rejoining the original validated Read and SNOMED codelists (see [Medcode generation process](https://github.com/Exeter-Diabetes/CPRD-Codelists/tree/main?tab=readme-ov-file#medcodes)) with the June 2024 CPRD Aurum Medical Dictionary, or by searching for key words/terms in the June 2024 CPRD Aurum Medical Dictionary (whichever method was used to create the original 2020 codelist). Any new codes found were reviewed before addition. Medcode lists which have been updated are: 'all diabetes', 'QOF diabetes', diabetes insipidus (not used pre-2024), family history of diabetes and premature CVD, all biomarkers, all comorbidities except care home (NB: retinopathy now divided into severe and non-severe), hearing loss, pulmonary embolism, deep vein thrombosis, surgical pancreatic resection and pancreatic insufficiency (NB: weight loss and polydipsia only added in 2024 so may not contain all codes from October 2020), ethnicity, alcohol, smoking. Some codelists have also changed in their scope due to changes in the algorithms they are used with: 'all diabetes' now contains all types of diabetes mellitus (previously, codes for non-type 1/type 2 diabetes were in an 'exclusion diabetes' codelist which also included diabetes insipidus; the latter is now a separate codelist). Prodcode lists were updated by searching for known generic and brand names in the June 2024 CPRD Aurum Product Dictionary (some lists available in this repository at Prodcode lists/Drug name lists/). Prodcode lists which have been updated are the four blood pressure medication codelists ('ace_inhibitors', 'beta_blockers', 'ca_channel_blockers', and 'arb'), some diabetes medications ('ohas', 'insulin', 'sglt2', 'thijs_glp1' \[note this differs from OHA codelist as based on September 2024 dictionary and contains tirzepatide codes]), statins, finerenone (in Renal medications; added in 2024 so may not contain all codes from October 2020), oral steroids, definite genital infection meds, topical candidal meds and oestrogens. Codelists which are new for 2024: antipsychotics, blindness_and_visual_impairment, charcot_foot, vitreous_and_pre_retinal_haemorrhage, peripheral_neuropathy, painful_peripheral_neuropathy, non_severe_neuropathy (NB: peripheral_neuropathy=painful_peripheral_neuropathy and non_severe_neuropathy combined), foot_ulcer_infection_ischaemia, gastroparesis, lower_limb_amputation, neuropathic_pain, hyperglyacemic_crisis, ANCA-associated vasculitis (aav), Autosomal dominant polycystic kidney disease (adpkd), Alport syndrome (alport), Anti-GBM disease (antigbm), Fabry disease (fabry), Focal segmental glomerulosclerosis (fsgs), Glomerulonephritis NOS (gn_nos), IgA nephropathy (igan), Minimal change disease (mcd), Membranous glomerulonephritis (membranous), Membranoproliferative glomerulonephritis (mpgn), Other polycystic kidney disease (other_pkd), and Systemic lupus erythematosus / lupus nephritis (sle).
...
* 2019 Index of Multiple Deprivation (IMD) deciles were converted to 2011 Townsend Deprivation Scores (TDS) by matching on 2011 Lower Super Output Area (LSOA) and using the median TDS score (to 3 d.p.) of LSOAs with the same IMD decile of the patient
* 2019 IMD decile-2011 LSOA lookup from here: https://www.gov.uk/government/statistics/english-indices-of-deprivation-2019
...
*Exception: For most biomarkers (24hr urine protein, ACR, blood albumin, ALT, AST, bilirubin, blood creatinine, urine creatinine, FE1, fasting glucose, haematocrit, haemoglobin, HDL, LDL, PCR, total cholesterol, tryglycerides, TSH, TTG, urine dipstick protein) we have used the NHS Pathology Bounded Code List (PBCL) 2018, a subset of codes used for the majority of test reporting. We term searched the PBCL list for each biomarker (PBCL codes identified are available [here](https://github.com/Exeter-Diabetes/CPRD-Codelists/tree/main/Medcodes/Biomarkers/PBCL%20codelists)) and then mapped the resulting Read/SNOMED codes to medcodes (clinician review not necessary). The PBCL has now been replaced by the PaLM (pathology and laboratory medicine) reference set; in 2024, we checked to see whether including SNOMED codes in the latest PaLM reference set which were not in the 2018 PBCL would significantly improve biomarker capture in a June 2024 CPRD Aurum extract: it did not, and so we are continuing to use the 2018 PBCL. 

In addition, a subset of medcode lists were generated by alternative means: Covid medcodes were provided by CPRD; ethnicity medcodes were provided by LSHTM and updated by us in June 2024 by Read code searching; hearing loss medcodes were provided by the [GEMINI team](https://github.com/GEMINI-multimorbidity/GEMINI-LTC-code-list-Public/tree/main); care home, bipolar disorder, schizophrenia, pulmonary embolism, deep vein thrombosis, coeliac disease, Crohns, depressive episode, GORD, Graves' disease, migraine, multiple sclerosis, osteoarthritis, psoriatic arthritis, psoriasis, recurrent depressive disorder, sleep disturbance, and ulcerative colitis medcodes were provided by collaborators; family history, frailty ('frailty_simple'), diabetes, learning disabilities, severe mental illness, surgical pancreatic resection, pancreatic insufficiency, weight loss, polydipsia and various biomarker medcodes (C-peptide, cholesterol:HDL ratio, GAD/IA2/ICA antibodies, HbA1c) were generated by searching for key words/terms in the CPRD Aurum Medical Dictionary for completeness. Read and SNOMED codelists are not available for these conditions/biomarkers. 'qresearch' codelists are from the QCode library.
