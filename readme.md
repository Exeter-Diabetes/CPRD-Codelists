...
CPRD Aurum codelists from the Exeter Diabetes team. These include medcode (for use with the Observation table) and prodcode (for use with the Drug Issue table) lists, as well as ICD10 and OPCS4 codelists for use with linked HES APC data.
